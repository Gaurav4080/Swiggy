function Shimmer() {
    return (
        <div className='w-full'>
            <div className='w-full text-slate-300 flex justify-center items-center flex-col gap-5 h-[300px] bg-slate-900'>
                <div className="relative flex items-start">
                    <img className="w-10 absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/icecream_wwomsa" />
                    <span className="loader "></span>
                </div>
                <h1 className='text-2xl'>Looking for great food near you...</h1>
            </div>
            <div className="w-[80%] mx-auto py-10 flex flex-wrap gap-7">
                {Array(12)
                    .fill("")
                    .map((data, i) => (
